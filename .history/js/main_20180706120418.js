    ...
    const ratePromise = idb.open(dbases, 1, upgradeDb => {
        ...
        switch (upgradeDb.oldVersion) {
            ...
            case 1:
                ...
                upgradeDb.createObjectStore('Rates', { keyPath: 'xchangeCountries' });
            case 2:
                var storer = responseDB.transaction('Rates');
                storer.createIndex('name', 'name', { Unique: true });
    ...
    fetch(convUrl)
        ...
        .then(rata => {
            ratePromise.then(db => {
                    ...
                    rateStore.put({
                        'xchangeCountries': `${Object.keys(rata)}`,
